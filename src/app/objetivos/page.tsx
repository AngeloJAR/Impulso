...
function ObjetivosContent() {
  ...
  const objetivosFiltrados = useMemo(() => {
    ...
    return objetivos.filter((objetivo) => {
      const perteneceAlProyecto = proyectoId ? objetivo.proyecto_id === proyectoId : true;
          ...
          <div className="relative grid gap-6 p-6 md:grid-cols-[1fr_340px] md:p-8">
            ...
            <div className="relative">
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-200 md:text-base">
                Crea objetivos por proyecto y conviértelos rápidamente en tareas concretas para
                avanzar sin perder el hilo.
              </p>
            ...
            <Card className="relative rounded-[2rem] border-white/10 bg-slate-950/72 p-6 text-white shadow-[0_18px_70px_rgba(2,6,23,0.28)] backdrop-blur-2xl">
              <p className="text-sm font-semibold text-slate-300">Flujo correcto</p>

              <div className="mt-5 grid gap-3">
                {["Proyecto", "Objetivo", "Tarea", "Calendario"].map((item, index) => (
                  <div
                    key={item}
        ...
        <section className="grid gap-6 xl:grid-cols-[1fr_420px]">
          <Card className="rounded-[2rem] border-white/10 bg-slate-950/44 p-6 text-white shadow-[0_24px_90px_rgba(2,6,23,0.28)] backdrop-blur-2xl">
            <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              <div>
                <h2 className="text-xl font-black text-white">Objetivos por proyecto</h2>
            ...
            {loadingObjetivos ? (
              <div className="rounded-3xl border border-dashed border-white/20 bg-white/10 p-6 text-center backdrop-blur-xl">
                <p className="text-sm font-medium text-slate-300">Cargando objetivos...</p>
              </div>
            ) : objetivosFiltrados.length === 0 ? (
              <div className="rounded-3xl border border-dashed border-white/20 bg-white/10 p-6 text-center backdrop-blur-xl">
                <Target className="mx-auto mb-3 h-8 w-8 text-slate-300" />

                <p className="font-semibold text-white">Todavía no hay objetivos</p>
                    ...
                    >
                      ...
                      <div className="mt-5">
                        <div className="mb-2 flex items-center justify-between text-xs font-semibold">
                          ...
                          <span className="text-white">{objetivo.progreso ?? 0}%</span>
                        </div>
          ...
          <div className="grid gap-6">
            ...
            >
              <div className="mb-5 flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-black text-white">Nuevo objetivo</h2>
              ...
              {proyectoSeleccionado ? (
                <div className="mb-5 rounded-3xl border border-sky-200/20 bg-sky-300/15 p-4 backdrop-blur-xl">
                  ...
                  <p className="mt-1 text-sm font-bold text-white">{proyectoSeleccionado.nombre}</p>
                </div>
              ) : null}
            ...
            <Card className="rounded-[2rem] border-white/10 bg-slate-950/44 p-6 text-white shadow-[0_24px_90px_rgba(2,6,23,0.28)] backdrop-blur-2xl">
              <div className="mb-5 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-300">Crear una tarea para avanzar.</p>
                </div>
              </div>

              <p className="text-sm leading-6 text-slate-300">
                Después de crear el objetivo, la app te llevará directo al formulario de tareas con
                el objetivo ya seleccionado.
              </p>
            </Card>
          </div>
        </section>
